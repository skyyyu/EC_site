...
<div id="enrollment">
	<div id="content" class="two-column">
		...
		<?php if (have_posts()) : usces_remove_filter(); ?>
			...
			<div class="enrollment_form" id="wc_<?php usces_page_name(); ?>">
							...
							<form action="<?php echo apply_filters('usces_filter_newmember_form_action', usces_url('member', 'return')); ?>" method="post" onKeyDown="if (event.keyCode == 13) {return false;}">
								<table border="0" cellpadding="0" cellspacing="0" class="customer_form">
									...
									<tr>
										...
										<td colspan="2"><input class="hidden" value=" " /><input name="member[password1]" id="password1" type="password" class="enrollment_password" value="<?php usces_memberinfo('password1'); ?>" autocomplete="off" /></td>
									</tr>
									<tr>
										<th scope="row"><em><?php _e('*', 'usces'); ?></em><?php _e('Password (confirm)', 'usces'); ?></th>
										<td colspan="2"><input name="member[password2]" id="password2" type="password" class="enrollment_password" value="<?php usces_memberinfo('password2'); ?>" /></td>
									</tr>
