				...
				<div class="item_page">
					<div class="itemimg">
						<ul class="slides">
							...
							<li id="image_place"><a href="<?php usces_the_itemImageURL($id); ?>" <?php echo apply_filters('usces_itemimg_anchor_rel', NULL); ?>><?php usces_the_itemImage($id, 135, 135, $post); ?></a></li>
							<?php endforeach; ?>
						</ul>
